...
import org.opencv.xfeatures2d.BOWTrainer;
...
public class BOWKMeansTrainer extends BOWTrainer {
    ...
    //
    // C++:   cv::xfeatures2d::BOWKMeansTrainer::BOWKMeansTrainer(int clusterCount, TermCriteria termcrit = TermCriteria(), int attempts = 3, int flags = KMEANS_PP_CENTERS)
    //
    ...
    //
    // C++:  Mat cv::xfeatures2d::BOWKMeansTrainer::cluster()
    //
    ...
    //
    // C++:  Mat cv::xfeatures2d::BOWKMeansTrainer::cluster(Mat descriptors)
    //
