...
OPENCV_MODULES:=stitching bgsegm bioinspired ccalib dnn_objdetect dnn_superres dpm face fuzzy gapi hfs img_hash intensity_transform line_descriptor quality rapid reg rgbd ptcloud saliency signal structured_light calib phase_unwrapping superres optflow surface_matching videostab wechat_qrcode objdetect xfeatures2d shape ximgproc xobjdetect xphoto photo xstereo tracking highgui datasets videoio video text imgcodecs features dnn stereo plot ml imgproc geometry flann core
